...
//                free_ast_node(node->var_decl.initializer);
//            }
//            break;
...
//            free_ast_node(node->member_access_expr.object);
//            if (node->member_access_expr.member_name != NULL) {
//                free(node->member_access_expr.member_name);
//            }
//            break;
//
//        case AST_PROGRAM:
...
//                    free_ast_node(node->program.statements->nodes[i]);
//                }
//                free_ast_node_list(node->program.statements);
//            }
//            break;

            // TODO: add cases for other AST node types as needed
